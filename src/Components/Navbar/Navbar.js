        ...
        <div className={classes.navbar}>
            ...
            <div className={classes.items}>
              <ul>
                <li className={classes.nav}>
                  <Link to="/" className={classes.reactlhomelink}>
                    React
                  </Link>{" "}
                </li>
              </ul>
          ...
          <div className={classes.items}>
            <div className={classes.nav}>
              <ul>
                <li>
                  <Link to="/version" className={classes.links}>
                    v17.02
                  </Link>{" "}
                </li>
                <li>
                  <Link to="/languages" className={classes.links}>
                    <IoLanguageSharp className="langlogo" />
                    Languages
                  </Link>
                </li>
                <li>
                  <a href="https://github.com/Rahat-0/react.js-website.git" className={classes.links}>
                    Github
                  </a>
                </li>
              </ul>
